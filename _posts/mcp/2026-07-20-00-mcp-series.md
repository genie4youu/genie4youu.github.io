...
description: MCP 프로토콜 이론부터 MATLAB MCP 서버 연결과 검증까지 17편의 목차. 스펙 2025-11-25 기준.
date: 2026-07-20 06:20:00 +0900
categories: [AI 에이전트, 목차]
pin: true
...
MCP(Model Context Protocol)의 프로토콜 이론과, MATLAB에 MCP 서버를 붙여 Stateflow 모델을 다루는 실무 설정을 17편으로 정리한다.
...
| 09 | [설치 — MCP 서버 등록](/posts/09-mcp-codex-setup/) | 설정 파일, 승인과 샌드박스 |
