...
**마지막 항목을 본다.** 신호가 안정되지 않고 계속 튀기만 하면 **정상적인 입력이 아니라 고장난 신호일 수 있다.** 억지로 해석하지 않고 Fault로 격리해 회복할 시간을 준다.
...
- 기준을 샘플로 세든 시간으로 세든, **짧은 튐을 성급하게 받아들이지 않는다**
