...
길이 $r$ 이하 버스트는 전부 잡는다. CRC-16 이면 연속 16비트가 통째로 뭉개져도 100% 검출된다. 패리티나 체크섬은 이런 보장을 주지 못한다. 그리고 무작위 오류의 미검출 확률은 대략 $2^{-r}$ 로, CRC-16 이면 1/65536, CRC-32 면 $1/4.3\times10^9$ 이다.
